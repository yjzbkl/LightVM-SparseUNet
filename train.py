...
def evaluate(model, loader, criterion, device, threshold):
    ...
    for images, masks in loader:
        ...
        metrics = binary_segmentation_metrics(logits, masks, threshold=threshold, compute_hd=False)
...
def main():
    ...
    # The test split is deliberately not constructed or accessed during training.
    train_dataset, val_dataset = build_datasets(cfg, splits=("train", "val"))
